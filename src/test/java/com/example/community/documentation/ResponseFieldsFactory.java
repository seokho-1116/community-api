...
public class ResponseFieldsFactory {
  ...
  public static FieldDescriptor[] getPageCommentsResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
  ...
  public static FieldDescriptor[] getCommentUpdateResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
        fieldWithPath("data").type(OBJECT).description("응답 데이터"),
  ...
  public static FieldDescriptor[] getCommentDeleteResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
        fieldWithPath("data").type(OBJECT).description("응답 데이터"),
        fieldWithPath("data.commentId").type(STRING).description("생성된 댓글 id")
  ...
  public static FieldDescriptor[] getCommentCreateResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
        fieldWithPath("data").type(OBJECT).description("응답 데이터"),
        fieldWithPath("data.commentId").type(STRING).description("생성된 댓글 id")
  ...
  public static FieldDescriptor[] getMemberCreateResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
        fieldWithPath("data").type(OBJECT).description("응답 데이터"),
  ...
  public static FieldDescriptor[] getMemberDetailResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
        fieldWithPath("data").type(OBJECT).description("응답 데이터"),
  ...
  public static FieldDescriptor[] getMemberEmailUpdateResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
        fieldWithPath("data").type(OBJECT).description("응답 데이터"),
  ...
  public static FieldDescriptor[] getMemberPasswordUpdateResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
  ...
  public static FieldDescriptor[] getMemberNicknameUpdateResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
        fieldWithPath("data").type(OBJECT).description("응답 데이터"),
  ...
  public static FieldDescriptor[] getLoginSuccessResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
        fieldWithPath("data").type(OBJECT).description("응답 데이터"),
  ...
  public static FieldDescriptor[] getTokenRefreshResponseField() {
    return new FieldDescriptor[] {
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
        fieldWithPath("data").type(OBJECT).description("응답 데이터"),
        fieldWithPath("data.accessToken").type(STRING).description("액세스 토큰"),
