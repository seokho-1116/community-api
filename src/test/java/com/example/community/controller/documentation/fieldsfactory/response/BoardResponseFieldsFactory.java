...
public class BoardResponseFieldsFactory {
  public static List<FieldDescriptor> boardSummaryResponseFields() {
    return List.of(
  ...
  public static List<FieldDescriptor> boardDetailResponseFields() {
    return List.of(
        fieldWithPath("message").type(STRING).description("응답 메시지 (정상: success)"),
